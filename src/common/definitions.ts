...
export const COUNTRY_POLICY_TYPES: CountryPolicyType[] = [
  ...
  new CountryPolicyType(4, 3000, '人材開発', '政務庁が利用可能になる。政務官 +1ポイント', 2),
  ...
  new CountryPolicyType(34, 2000, '採用策', '政務官 +1ポイント',
...
export const CHARACTER_SKILL_TYPES: CharacterSkillType[] = [
  ...
  new CharacterSkillType(38, '兵家 Lv.3', '攻撃力 +40、突撃確率 +10%、突撃攻撃力 +80、連戦確率 +10%', 8, (skills) => skills.some((s) => s.type === 37)),
