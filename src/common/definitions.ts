...
export const SOLDIER_TYPES: SoldierType[] = [
  ...
  new SoldierType(36, 0, 5, '槍騎兵', 10, 600, '50', '50', '（特殊）中級兵種。弩に強く戟に弱い'),
  new SoldierType(37, 0, 6, '弓騎兵', 10, 600, '50', '50', '（特殊）中級兵種。戟に強く騎に弱い'),
  ...
  new SoldierType(17, 0, 5, '異民族兵A', 32767, 32767, '0', '0', ''),
  new SoldierType(18, 0, 5, '異民族兵B', 32767, 32767, '0', '0', ''),
  new SoldierType(19, 0, 5, '異民族兵C', 32767, 32767, '0', '0', ''),
