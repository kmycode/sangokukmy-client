...
export const SOLDIER_TYPES: SoldierType[] = [
  ...
  new SoldierType(3, 0, 4, '軽戟兵', 4, 100, '30', '10', '低級兵種。突撃に補正'),
  new SoldierType(30, 0, 5, '牛兵', 4, 200, '30', '10', '低級兵種。突撃に補正'),
  new SoldierType(31, 0, 6, '投石兵', 4, 200, '10', '30', '低級兵種。敵を混乱させることがある'),
  new SoldierType(4, 0, 6, '弓兵', 4, 200, '20', '20', '低級兵種。対歩兵に特化'),
  new SoldierType(32, 0, 2, '祈祷兵', 6, 300, '0', '0', '低級兵種。陣形の相性により大きな攻撃力を得る'),
  new SoldierType(5, 0, 5, '軽騎兵', 9, 300, '40', '20', '中級兵種。連戦、突撃に補正'),
  new SoldierType(33, 0, 4, '戟兵', 9, 300, '40', '20', '中級兵種。連戦、突撃に補正'),
  new SoldierType(34, 0, 4, '槍兵', 9, 400, '30', '20', '中級兵種。対騎兵に特化'),
  new SoldierType(13, 0, 2, '衝車', 16, 500, '0', '0', '対城壁に特化', undefined, undefined, undefined, undefined, 1),
  ...
  new SoldierType(36, 0, 5, '槍騎兵', 9, 600, '40', '20', '中級兵種。陣形の相性により攻撃力を得る', undefined, undefined, undefined, undefined, 3),
  new SoldierType(37, 0, 6, '弓騎兵', 9, 600, '20', '40', '中級兵種。陣形の相性により攻撃力と防御力を得る', undefined, undefined, undefined, undefined, 3),
  new SoldierType(8, 0, 4, '重戟兵', 13, 800, '60', '30', '高級兵種。突撃に補正', undefined, true, 75, undefined, 1),
  new SoldierType(9, 0, 5, '重騎兵', 13, 800, '60', '30', '高級兵種。連戦、突撃に補正', undefined, true, 76, undefined, 2),
  new SoldierType(6, 0, 6, '強弩兵', 13, 800, '50', '40', '高級兵種。高い攻撃力、防御力を持つ', undefined, true, 63, undefined, 3),
  new SoldierType(11, 0, 6, '連弩兵', 15, 1000, '20', '30', '高級兵種。陣形の相性により攻撃力を得る', undefined, true, 63, undefined, 3),
  new SoldierType(26, 0, 4, '青洲兵', 17, 700, '90', '70', '強い攻撃力を持ち、突撃に補正', undefined, true, 64, undefined, 1),
  new SoldierType(38, 0, 5, '戦車兵', 17, 800, '90', '50', '強い攻撃力を持ち、連戦に補正', undefined, true, 77, undefined, 3),
  new SoldierType(27, 0, 5, '象兵', 17, 900, '20', '20', '突撃に大きな補正', undefined, true, 67, undefined, 1),
  new SoldierType(28, 0, 4, '藤甲兵', 17, 900, '0', '150', '高い防御力を持つ', undefined, true, 68, undefined, 2),
  ...
  new SoldierType(23, 1, 4, '梓叡兵', 6, 300, '0', '0', '文官向けの最弱の兵種', undefined, undefined, undefined, [48, 10]),
  new SoldierType(7, 1, 4, '梓神兵',  12, 400, '30', '10', '文官向けの兵種。相手を混乱させることができる'),
  new SoldierType(42, 1, 6, '梓弓兵', 12, 500, '20', '20', '文官向けの兵種。相手を混乱させることができる', undefined, undefined, undefined, undefined, 2),
  new SoldierType(24, 1, 5, '梓馬兵', 12, 700, '40', '0', '文官向けの兵種。相手を混乱させることができる。突撃に補正', undefined, undefined, undefined, undefined, 1),
  new SoldierType(29, 1, 6, '梓琴兵', 18, 700, '40', '20', '文官向けの兵種。歩兵に強い。同士討ちを誘う', undefined, undefined, undefined, 50),
  new SoldierType(43, 1, 6, '梓弩兵', 18, 1000, '30', '30', '文官向けの兵種。陣形の相性により攻撃力を得る', undefined, undefined, undefined, 50, 2),
  new SoldierType(44, 1, 4, '工作兵', 18, 1000, '0', '0', '文官向けの兵種。基礎能力を犠牲にし、城壁へ少しの攻撃力の他、相手の混乱と同士討ちを誘う', undefined, undefined, undefined, undefined, 1),
...
export const FORMATION_TYPES: FormationType[] = [
  ...
  new FormationType(1, 500, '魚鱗', ['攻撃力 +8',
                                    '攻撃力 +16',
  ...
  new FormationType(2, 500, '蜂矢', ['攻撃力 +8',
                                    '攻撃力 +16',
                                    '攻撃力 +16、防御力 +16、属性攻撃力 +16',
  ...
  new FormationType(3, 500, '錐行', ['攻撃力 +8',
                                    '攻撃力 +16',
                                    '攻撃力 +16、防御力 +16、属性攻撃力 +16',
                                    '攻撃力 +16、防御力 +16、属性攻撃力 +32、属性防御力 +16、突撃確率 +16%、突撃攻撃力 +40',
                                    '攻撃力 +16、防御力 +16、属性攻撃力 +48、属性防御力 +32、突撃確率 +16%、突撃攻撃力 +40、連戦確率 +4%'],
                        '金', undefined, true, [1000, 2000, 5000, 8000]),
  new FormationType(4, 500, '鶴翼', ['攻撃力 +8',
                                    '攻撃力 +16',
                                    '攻撃力 +16、防御力 +16、属性攻撃力 +16',
                                    '攻撃力 +16、防御力 +16、属性攻撃力 +32、属性防御力 +16、突撃確率 +16%、突撃攻撃力 +40',
                                    '攻撃力 +16、防御力 +16、属性攻撃力 +48、属性防御力 +32、突撃確率 +16%、突撃攻撃力 +40、連戦確率 +4%'],
