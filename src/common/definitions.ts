...
export const SOLDIER_TYPES: SoldierType[] = [
  ...
  new SoldierType(32, 0, 2, 0, 0, '祈祷兵', 20, 800, '0', '0', '（特殊）低級兵種。陣形の相性により大きな攻撃力を得る'),
  new SoldierType(34, 0, 4, 0, 0, '槍兵', 12, 500, '30', '30', '（特殊）低級兵種'),
  new SoldierType(31, 0, 4, 0, 0, '投石兵', 10, 600, '50', '50', '（特殊）中級兵種'),
  new SoldierType(36, 0, 5, 0, 0, '槍騎兵', 10, 600, '50', '50', '（特殊）中級兵種。弩に強く戟に弱い'),
  new SoldierType(37, 0, 6, 0, 0, '弓騎兵', 10, 600, '50', '50', '（特殊）中級兵種。戟に強く騎に弱い'),
  ...
  new SoldierType(29, 1, 2, 3, 0, '梓琴兵', 23, 600, '0', '0', '文官向けの兵種', undefined, undefined, undefined, 50),
  new SoldierType(43, 1, 6, 3, 0, '梓弩兵', 33, 1300, '70', '70', '文官向けの兵種。戟に強く騎に弱い', undefined, undefined, undefined, 50),
  new SoldierType(44, 1, 4, 1, 0, '工作兵', 20, 1000, '0', '0', '文官向けの兵種'),
  new SoldierType(12, 1, 7, 2, 0, '壁守兵', 20, 1000, '0', '110', '文官向けの兵種。高い防御力を持つ'),
  new SoldierType(25, 3, 4, 0, 0, '義勇兵', 8, 300, '0', '0', '仁官向けの最弱の兵種', 30),
  new SoldierType(39, 3, 4, 1, 0, '義戈兵', 12, 400, '30', '10', '仁官向けの兵種。連戦に補正', undefined, undefined, undefined, 51),
...
export const CHARACTER_SKILL_TYPES: CharacterSkillType[] = [
  ...
  new CharacterSkillType(59, '儒家 Lv.2', '国に仕官している場合の布教効果 +100%', 100, (skills) => skills.some((s) => s.type === 58)),
  new CharacterSkillType(60, '儒家 Lv.3', '国教を信仰する都市の内政効果 +100%', 600, (skills) => skills.some((s) => s.type === 59)),
  ...
  new CharacterSkillType(64, '道家 Lv.2', '国に仕官している場合の布教効果 +100%', 100, (skills) => skills.some((s) => s.type === 63)),
  new CharacterSkillType(65, '道家 Lv.3', '国教を信仰する都市の内政効果 +100%', 600, (skills) => skills.some((s) => s.type === 64)),
  ...
  new CharacterSkillType(69, '仏僧 Lv.2', '国に仕官している場合の布教効果 +100%', 100, (skills) => skills.some((s) => s.type === 68)),
  new CharacterSkillType(70, '仏僧 Lv.3', '国教を信仰する都市の内政効果 +100%', 600, (skills) => skills.some((s) => s.type === 69)),
