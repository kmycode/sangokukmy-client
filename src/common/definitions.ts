...
export const SOLDIER_TYPES: SoldierType[] = [
  ...
  new SoldierType(8, 0, 4, '重戟兵', 40, 800, '90', '90', '高級兵種。騎に強く弩に弱い', undefined, true, 75),
  ...
  new SoldierType(9, 0, 5, '重騎兵', 40, 800, '90', '90', '高級兵種。弩に強く戟に弱い', undefined, true, 76),
  ...
  new SoldierType(6, 0, 6, '強弩兵', 40, 800, '90', '90', '高級兵種。戟に強く騎に弱い', undefined, true, 83),
