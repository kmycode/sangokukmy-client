...
export const SOLDIER_TYPES: SoldierType[] = [
  ...
  new SoldierType(11, 0, '連弩兵', 20, 800, '90', '40', '連弩を持った兵士'),
...
export const FORMATION_TYPES: FormationType[] = [
  ...
  new FormationType(1, 500, '魚鱗', ['戟兵で攻撃力 +10',
                        ...
                        undefined, true, [1000, 3000, 6000, 10000]),
...
export const CHARACTER_SKILL_TYPES: CharacterSkillType[] = [
  ...
  new CharacterSkillType(4, '武家 Lv.4', '兵種 連弩兵、攻撃力 +20、突撃確率 +2%、突撃威力 +80', 10, (skills) => skills.some((s) => s.type === 3)),
  ...
  new CharacterSkillType(8, '官吏 Lv.3', '政策開発時、未取得政策ブースト確率 +0.5%', 8, (skills) => skills.some((s) => s.type === 7)),
  new CharacterSkillType(9, '官吏 Lv.4', '護衛属性含む兵種使用時、攻撃力 +20、防御力 +40', 12, (skills) => skills.some((s) => s.type === 8)),
  new CharacterSkillType(10, '官吏 Lv.5', '内政効果 +40%', 12, (skills) => skills.some((s) => s.type === 9)),
