...
export const SOLDIER_TYPES: SoldierType[] = [
  ...
  new SoldierType(3, 0, 4, '軽戟兵', 8, 200, '30', '30', '低級兵種'),
  new SoldierType(33, 0, 4, '戟兵', 14, 500, '60', '60', '中級兵種'),
  new SoldierType(8, 0, 4, '重戟兵', 20, 800, '90', '90', '高級兵種', undefined, true, 75),
  new SoldierType(26, 0, 4, '青洲兵', 35, 1200, '120', '120', '最高級兵種', undefined, true, 64, undefined, 3),
  new SoldierType(30, 0, 5, '牛兵', 8, 200, '30', '30', '低級兵種'),
  new SoldierType(5, 0, 5, '軽騎兵', 14, 500, '60', '60', '中級兵種'),
  new SoldierType(9, 0, 5, '重騎兵', 20, 800, '90', '90', '高級兵種', undefined, true, 76),
  new SoldierType(38, 0, 5, '戦車兵', 35, 1200, '120', '120', '最高級兵種', undefined, true, 77, undefined, 3),
  ...
  new SoldierType(11, 0, 6, '連弩兵', 35, 1200, '120', '120', '最高級兵種', undefined, true, 63, undefined, 3),
  new SoldierType(13, 0, 2, '衝車', 20, 500, '0', '0', '対城壁に特化', undefined, undefined, undefined, undefined, 1),
  new SoldierType(14, 0, 2, '井闌', 30, 600, '0', '0', '対城壁に特化。衝車より強い', undefined, undefined, undefined, undefined, 2),
  new SoldierType(35, 0, 2, '投石器', 40, 600, '0', '0', '対城壁に特化。井闌より強い', undefined, undefined, undefined, undefined, 2, 4),
  ...
  new SoldierType(36, 0, 5, '槍騎兵', 12, 600, '50', '50', '中級兵種'),
  new SoldierType(37, 0, 6, '弓騎兵', 12, 600, '50', '50', '中級兵種'),
  new SoldierType(27, 0, 5, '象兵', 25, 800, '0', '0', '突撃に大きな補正', undefined, true, 67, undefined, 1),
  new SoldierType(28, 0, 4, '藤甲兵', 25, 800, '0', '160', '高い防御力を持つ', undefined, true, 68, undefined, 2),
  new SoldierType(23, 1, 4, '梓叡兵', 8, 300, '0', '0', '文官向けの最弱の兵種', undefined, undefined, undefined, [48, 10]),
  new SoldierType(7, 1, 4, '梓歩兵',  15, 600, '30', '10', '文官向けの兵種'),
  new SoldierType(24, 1, 5, '梓馬兵', 15, 600, '40', '0', '文官向けの兵種'),
  new SoldierType(42, 1, 6, '梓弓兵', 15, 600, '20', '20', '文官向けの兵種'),
  new SoldierType(29, 1, 2, '梓琴兵', 25, 600, '0', '0', '文官向けの兵種', undefined, undefined, undefined, 50),
  new SoldierType(43, 1, 6, '梓弩兵', 35, 1300, '70', '70', '文官向けの兵種', undefined, undefined, undefined, 50),
  new SoldierType(44, 1, 4, '工作兵', 22, 1000, '0', '0', '文官向けの兵種', undefined, undefined, undefined, undefined, 2),
