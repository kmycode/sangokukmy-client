...
export const SOLDIER_TYPES: SoldierType[] = [
  ...
  new SoldierType(14, '井闌', 30, 500, '0', '0', '対城壁・守兵・壁守兵の場合に限り、攻撃力に200、防御力に40のボーナスを得る'),
  ...
  new SoldierType(20, '賊兵A', 32767, 32767, '0', '0', ''),
  new SoldierType(21, '賊兵B', 32767, 32767, '0', '0', ''),
  new SoldierType(22, '賊兵C', 32767, 32767, '0', '0', ''),
