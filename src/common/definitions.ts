...
export const CHARACTER_SKILL_TYPES: CharacterSkillType[] = [
  ...
  new CharacterSkillType(9, '官吏 Lv.4', '護衛属性含む兵種使用時、攻撃力 +20、防御力 +50', 360, (skills) => skills.some((s) => s.type === 8)),
  ...
  new CharacterSkillType(17, '技師 Lv.2', 'コマンド 資源生産、装備良戟・装備良馬生産可能', 360, (skills) => skills.some((s) => s.type === 16)),
  new CharacterSkillType(18, '技師 Lv.3', '装備連弩生産可能', 360, (skills) => skills.some((s) => s.type === 17)),
  new CharacterSkillType(19, '技師 Lv.4', 'アイテム上限 +3', 360, (skills) => skills.some((s) => s.type === 18)),
  new CharacterSkillType(20, '技師 Lv.5', '青洲槍生産可能', 320, (skills) => skills.some((s) => s.type === 19)),
  ...
  new CharacterSkillType(51, '農家 Lv.b3'),
  new CharacterSkillType(52, '農家 Lv.b4'),
  new CharacterSkillType(53, '農家 Lv.b5'),
  ...
  new CharacterSkillType(44, '学者 Lv.4', '私撰書生産可能、アイテム上限 +3', 400, (skills) => skills.some((s) => s.type === 43)),
  ...
  new CharacterSkillType(49, '参謀 Lv.4', '突撃確率 +2%、突撃攻撃力 +60', 320, (skills) => skills.some((s) => s.type === 48)),
  new CharacterSkillType(50, '参謀 Lv.5', '兵種 梓琴兵、戦闘が１ターンで終了時の連戦確率 +50%', 360, (skills) => skills.some((s) => s.type === 49)),
];
