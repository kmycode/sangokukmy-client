...
export const SOLDIER_TYPES: SoldierType[] = [
  ...
  new SoldierType(11, 0, '連弩兵', 4, 800, '90', '40', '連弩を持った兵士', undefined, true, 63),
  new SoldierType(26, 0, '青洲兵', 5, 900, '90', '70', '青洲出身の強力な兵士', undefined, true, 64),
...
export const CHARACTER_SKILL_TYPES: CharacterSkillType[] = [
  ...
  new CharacterSkillType(2, '武家 Lv.2', '攻撃力 +20', 8, (skills) => skills.some((s) => s.type === 1)),
  new CharacterSkillType(3, '武家 Lv.3', '徴兵に必要な金 -15%', 10, (skills) => skills.some((s) => s.type === 2)),
  new CharacterSkillType(4, '武家 Lv.4', '攻撃力 +20、突撃確率 +2%、突撃威力 +80', 8, (skills) => skills.some((s) => s.type === 3)),
  new CharacterSkillType(5, '武家 Lv.5', 'コマンド 都市巡回、戦闘が 1 ターンで終了時の連戦確率 +80%', 9, (skills) => skills.some((s) => s.type === 4)),
  new CharacterSkillType(6, '官吏 Lv.1', '毎月知力Ex +7', 0, (_) => false),
  new CharacterSkillType(7, '官吏 Lv.2', '内政効果 +40%', 8, (skills) => skills.some((s) => s.type === 6)),
  new CharacterSkillType(8, '官吏 Lv.3', '内政効果 +40%', 8, (skills) => skills.some((s) => s.type === 7)),
  new CharacterSkillType(9, '官吏 Lv.4', '護衛属性含む兵種使用時、攻撃力 +20、防御力 +40', 9, (skills) => skills.some((s) => s.type === 8)),
  ...
  new CharacterSkillType(17, '技師 Lv.2', 'コマンド 資源生産、装備良戟・装備良馬生産可能', 5, (skills) => skills.some((s) => s.type === 16)),
  new CharacterSkillType(18, '技師 Lv.3', '装備連弩生産可能', 8, (skills) => skills.some((s) => s.type === 17)),
  new CharacterSkillType(19, '技師 Lv.4', 'アイテム上限 +3', 10, (skills) => skills.some((s) => s.type === 18)),
  ...
  new CharacterSkillType(28, '胡人 Lv.3', '異民族と戦闘時に限り攻撃力 +100', 9, (skills) => skills.some((s) => s.type === 27)),
  new CharacterSkillType(29, '胡人 Lv.4', 'コマンド 農民避難、農民呼寄', 12, (skills) => skills.some((s) => s.type === 28)),
  new CharacterSkillType(30, '胡人 Lv.5', 'コマンド 胡人交易、象・藤甲生産可能', 8, (skills) => skills.some((s) => s.type === 29)),
  new CharacterSkillType(31, '農民 Lv.1', '政策によらず義勇兵雇用可能', 0, (_) => false),
  new CharacterSkillType(32, '農民 Lv.2', 'コマンド 精鋭検査、練兵生産可能', 8, (skills) => skills.some((s) => s.type === 31)),
  new CharacterSkillType(33, '農民 Lv.3', '米施し効果 +80%', 8, (skills) => skills.some((s) => s.type === 32)),
  new CharacterSkillType(34, '農民 Lv.4', 'コマンド 農民避難、農民呼寄', 7, (skills) => skills.some((s) => s.type === 33)),
  ...
  new CharacterSkillType(38, '兵家 Lv.3', '攻撃力 +40、突撃確率 +12%、突撃攻撃力 +60', 8, (skills) => skills.some((s) => s.type === 37)),
  ...
  new CharacterSkillType(44, '学者 Lv.4', '私撰書生産可能', 10, (skills) => skills.some((s) => s.type === 43)),
