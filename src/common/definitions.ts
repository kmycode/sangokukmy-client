...
export const CHARACTER_SKILL_TYPES: CharacterSkillType[] = [
  ...
  new CharacterSkillType(58, '儒家 Lv.1', '布教効果 +50%、攻撃力 -30、コマンド 国境布教', 0, (_) => false),
  ...
  new CharacterSkillType(63, '道家 Lv.1', '布教効果 +50%、攻撃力 -30、コマンド 国境布教', 0, (_) => false),
  ...
  new CharacterSkillType(68, '仏僧 Lv.1', '布教効果 +50%、攻撃力 -30、コマンド 国境布教', 0, (_) => false),
