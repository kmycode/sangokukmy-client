...
export const SOLDIER_TYPES: SoldierType[] = [
  new SoldierType(1, '雑兵', 10, 0, '0', '0'),
  new SoldierType(2, '禁兵', 10, 0, '15', '15'),
  new SoldierType(100, '雑兵・禁兵', 10, 0, '0 / 10', '0 / 10', 'このゲームにおける最弱の兵士。ただし、首都で徴兵した場合は禁兵が徴兵され、攻撃力・防御力に10のボーナスを得る'),
  new SoldierType(3, '軽歩兵',  20, 100, '10', '0', '軽装備の歩兵'),
  new SoldierType(4, '弓兵',    30, 200,  '0', '15', '弓を持った兵士'),
  new SoldierType(5, '軽騎兵',  50, 300, '35', '10', '軽装備の騎兵'),
  new SoldierType(6, '強弩兵',  70, 400, '10', '35', '弩を持った兵士'),
  new SoldierType(7, '神鬼兵',  100, 500, '知力', '0', '攻撃力に知力が補正として加算される'),
  new SoldierType(8, '重歩兵',  125, 600, '50', '30', '重装備の歩兵'),
  new SoldierType(9, '重騎兵',  150, 700, '60', '40', '重装備の騎兵'),
  new SoldierType(10, '智攻兵', 175, 800, '知力x0.8', '知力x0.4', '攻撃力、防御力、ともに知力が補正として加算される'),
  new SoldierType(11, '連弩兵', 200, 900, '90', '30', '連弩を持った兵士'),
  new SoldierType(12, '壁守兵', 225, 999, '0', '知力', '堅く守ることに特化した兵士。防御力に知力が補正として加算される'),
  new SoldierType(14, '井闌', 300, 500, '0', '0', '対城壁・守兵・壁守兵の場合に限り、攻撃力に200のボーナスを得る'),
