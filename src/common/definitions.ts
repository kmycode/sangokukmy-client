...
export const CHARACTER_SKILL_TYPES: CharacterSkillType[] = [
  ...
  new CharacterSkillType(57, '官吏 Lv.b2', '戦時中内政効果 +35%、コマンド 都市巡回', 320, (skills) => skills.some((s) => s.type === 6) && !skills.some((s) => s.type === 7)),
  ...
  new CharacterSkillType(54, '官吏 Lv.b3', '戦時中内政効果 +35%、政策開発時、未取得政策ブースト確率 +5%', 320,
