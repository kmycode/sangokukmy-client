          ...
          <div class="content-main">
            ...
            <div v-if="!model.systemData.isWaitingReset">
              <div v-if="model.systemData.ruleSet !== 2">
                ...
                <div class="alert alert-info" v-if="model.canReligion">宗教勝利の進捗状況　都市: <strong>{{ model.countryReligionTownCount }}</strong> / <strong>{{ model.townCountForReligionWin }}</strong> 、国: <strong>1</strong> / <strong>{{ model.sameReligionCountryCount }}</strong><span v-if="!model.isAllTownHaveReligion"><br>まだすべての都市が宗教を信仰していません</span></div>
              </div>
          ...
          <div class="setting-list">
            ...
            <div v-if="model.canCountryCommander" class="setting-row loading-container">
              ...
              <div>
                ...
                <button type="button" :class="{ 'btn': true, 'btn-outline-secondary': newCountryCommanderSubject !== 3 || newCountryCommanderSubjectData !== 11, 'btn-secondary': newCountryCommanderSubject === 3 && newCountryCommanderSubjectData === 11, }" @click="newCountryCommanderSubject = 3; newCountryCommanderSubjectData = 11; characterFilterMode = 1; model.updateCountryCharactersFiltering(newCountryCommanderSubject, newCountryCommanderSubjectData, 0)" v-if="model.canReligion">宗教系</button><br>
