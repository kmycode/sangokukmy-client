      ...
      <div v-if="isOpenAddSecretaryDialog" class="dialog-body">
        ...
        <div class="dialog-content dialog-content-secretary-main">
          <div>
            ...
            <button :class="{ 'btn': true, 'btn-outline-secondary': selectedSecretaryType !== 27, 'btn-secondary': selectedSecretaryType === 27, }" @click="selectedSecretaryType = 27">部隊長 (1)</button>
            <button :class="{ 'btn': true, 'btn-outline-secondary': selectedSecretaryType !== 29, 'btn-secondary': selectedSecretaryType === 29, }" @click="selectedSecretaryType = 29">斥候 (1)</button>
