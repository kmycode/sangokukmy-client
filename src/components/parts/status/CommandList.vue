  ...
  <div id="command-list">
    ...
    <div class="command-list" ref="list">
      <div class="loading-container">
        ...
        <div class="alert alert-warning alert-update-commander" v-if="list.store.myCountryCommanderAttribute.message && (list.store.myCountryCommanderAttribute.id > list.store.chatMessageRead.lastAttributeCommanderId)"><div class="message-singleline">能力指令: <KmyChatTagText :text="list.store.myCountryCommanderAttribute.message"/></div><button type="button" class="btn btn-sm btn-secondary" style="transform:translateY(-4px);margin:0" @click="updateCountryCommanderMessageRead(list.store.myCountryCommanderAttribute.id)">既読</button></div>
        <div class="alert alert-warning alert-update-commander" v-if="list.store.myCountryCommanderFrom.message && (list.store.myCountryCommanderFrom.id > list.store.chatMessageRead.lastFromCommanderId)"><div class="message-singleline">出身指令: <KmyChatTagText :text="list.store.myCountryCommanderFrom.message"/></div><button type="button" class="btn btn-sm btn-secondary" style="transform:translateY(-4px);margin:0" @click="updateCountryCommanderMessageRead(list.store.myCountryCommanderFrom.id)">既読</button></div>
        <div class="alert alert-warning alert-update-commander" v-if="list.store.myCountryCommanderPrivate.message && (list.store.myCountryCommanderPrivate.id > list.store.chatMessageRead.lastPrivateCommanderId)"><div class="message-singleline">個人指令: <KmyChatTagText :text="list.store.myCountryCommanderPrivate.message"/></div><button type="button" class="btn btn-sm btn-secondary" style="transform:translateY(-4px);margin:0" @click="updateCountryCommanderMessageRead(list.store.myCountryCommanderPrivate.id)">既読</button></div>
