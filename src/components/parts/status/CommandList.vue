  ...
  <div id="command-list">
    ...
    <div class="loading-container">
      ...
      <div v-show="selectedCommandCategory === 0" class="commands">
        ...
        <button type="button" :class="{ 'btn': true, 'btn-light': list.isCountryCharacter, 'btn-outline-success': !list.isCountryCharacter }" :disabled="!list.inputer.canInput" @click="list.inputer.inputCommand(71)" v-if="model.canReligion"><span class="redundant-text">国教</span>布教</button>
