  ...
  <div id="command-list">
    ...
    <div class="loading-container">
      ...
      <div v-show="selectedCommandCategory === 0" class="commands">
        ...
        <button v-if="list.canReligion && list.canInputMissionary" type="button" :class="{ 'btn': true, 'btn-light': list.isCountryCharacter, 'btn-outline-success': !list.isCountryCharacter }" :disabled="!list.inputer.canInput" @click="list.inputer.inputCommand(71)"><span class="redundant-text">国教</span>布教</button>
      ...
      <div v-show="selectedCommandCategory === 2" class="commands">
        ...
        <button v-if="list.canReligion" type="button" :class="{ 'btn': true, 'btn-light': list.isCountryCharacter, 'btn-outline-success': !list.isCountryCharacter }" :disabled="!list.inputer.canInput" @click="$emit('open', 'soldier-religion')">使徒徴兵</button>
      ...
      <div v-show="selectedCommandCategory === 5" class="commands">
        ...
        <button v-if="list.store.character.countryId" type="button" class="btn btn-danger" :disabled="!list.inputer.canInput" @click="onResignCommand">下野</button>
      </div>
...
export default class CommandListView extends Vue {
  ...
  private onResignCommand() {
    this.$emit('yesno', {
      message: '下野すると数日間他国に仕官できなくなります。本当に下野しますか？',
      onYes: () => this.list.inputer.inputCommand(69),
    });
  }
